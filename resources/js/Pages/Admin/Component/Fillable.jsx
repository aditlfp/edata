  ...
  return (
    <>
      ...
      <div className="w-[8.5in] min-h-[11in] bg-white flex flex-col page">
        <img src={Header} alt="header" className="mt-[-6pt] pl-[20pt]" />
        <div className="mx-[70pt] leading-tight">
          <p className="text-center font-bold underline underline-offset-[2pt] decoration-[1pt]">
            SURAT PERJANJIAN KERJA WAKTU <br /> TERTENTU (KONTRAK)
          </p>
          <p className="text-center">Nomor : {props.no_srt}</p>
          <div className="text-justify">
            <p className="mt-[20pt]">
              Pada hari ini, {day}, telah dibuat dan disepakati perjanjian kerja
              antara:
            </p>
              ...
              <table className=" table-auto w-full mt-[12pt]">
                <tbody>
                  <tr className="table-row">
                    ...
                    <td className="w-[120pt]">Nama</td>
                    <td>: {formatName(props.nama_pk_kda)}</td>
                  </tr>
                  <tr className="table-row">
                    <td></td>
                    <td>Tempat/ Tgl Lahir</td>
                    <td>
                      : {props.tempat_lahir_pk_kda}, {props.tgl_lahir_pk_kda}
                    </td>
                  </tr>
                  <tr className="table-row">
                    <td></td>
            ...
            <table className="w-full border-collapse">
              <tbody>
                <tr>
                  ...
                  <td className="whitespace-normal text-justify break-normal">
          ...
          <table className="w-full border-collapse">
            <tbody>
              <tr>
                ...
                <td className="whitespace-normal text-justify break-normal">
                  PIHAK PERTAMA menetapkan PIHAK KEDUA untuk bekerja di PT Surya
                  Amanah Cendekia Ponorogo sebagai:
                  <table>
                    <tbody>
                      <tr>
                        <td className="w-[20pt]">a.</td>
                        <td className="w-[94pt]">Jabatan</td>
                        <td>: {formatName(props.jabatan_pk_kda)}</td>
                      </tr>
                      <tr>
                        <td>b.</td>
                        <td>Status</td>
              ...
              <tr>
                ...
                <td>
                  ...
                  terhitung mulai dari {dateContract}. Perjanjian ini dapat
                  diperpanjang lagi sesuai dengan ketentuan yang berlaku.
                </td>
              </tr>
              <tr>
          ...
          <table className=" w-full border-collapse">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  PIHAK KEDUA bersedia tunduk dan melaksanakan seluruh ketentuan
                  yang telah diatur dalam Peraturan Perusahaan dan tata tertib
                  perusahaan maupun ketentuan lain yang menjadi keputusan
                  Direksi dan Manajemen Perusahaan. PIHAK KEDUA bersedia
                  menyimpan dan menjaga kerahasiaan baik dokumen maupun
                  informasi milik PIHAK PERTAMA dan tidak dibenarkan memberikan
                  dokumen atau informasi yang diketahui baik secara lisan maupun
              ...
              <tr>
                ...
                <td>
                  PIHAK PERTAMA berhak memutasikan PIHAK KEDUA untuk bekerja di
                  tempat dan posisi yang lain selain yang tercantum di dalam
                  perjanjian ini selama masa perjanjian ini berlangsung dianggap
                  perlu.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  menaati sepenuhnya setiap ketentuan dan peraturan yang berlaku
                  pada PIHAK PERTAMA dan ketentuan yang berlaku pada PERUSAHAAN.
                </td>
              </tr>
              <tr>
                <td style={{ verticalAlign: "top" }}>3.7.</td>
                <td>
                  PIHAK KEDUA berkewajiban menyelesaikan masa kontrak yang telah
                  di tandatangani.
                </td>
              </tr>
            </tbody>
                  ...
                  <table className="ml-[12pt]">
                    <tbody>
                      <tr>
                        ...
                        <td
                          className={
                            props.tj_hadir == 0 || props.kinerja == 0
                              ? "w-[100pt]"
                              : ""
                          }
                        >
                      ...
                      {props.tj_hadir == 0 || props.kinerja == 0 ? (
                        <tr>
                          <td>b.</td>
                          <td colSpan={3}>
                            Lembur dan insentif dengan perhitungan mengikuti
