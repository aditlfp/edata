...
import Tapak from "/public/assets/tapak.png";
import Stampel from "/public/assets/stampel.png";
...
export default function Readable({ props }) {
  ...
  return (
    <>
      {/* Hal 3 */}
      <div className="w-[8.5in] min-h-[11in] bg-white flex flex-col page">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  PIHAK KEDUA berhak atas THR sebesar 1 (satu) bulan Gaji Pokok
                  apabila telah bekerja selama 12 (dua belas) bulan berturut
                  –turut. Apabila kurang dari 12 (dua belas) bulan setelah masa
                  percobaan <i>(training)</i> maka perhitungan THR dilakukan
                  secara prorata.
                </td>
              </tr>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  untuk bekerja di luar jam kerja dengan ketentuan yang berlaku.
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  berhak atas upah lembur berdasarkan aturan dan ketentuan pada
                  PERUSAHAAN. Pelaksanaan lembur harus berdasarkan perintah
                  lembur dari atasan yang berwenang di PERUSAHAAN.
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table className=" table-fixed">
            <tbody>
              <tr>
                ...
                <td>
                  PIHAK PERTAMA melakukan evaluasi kinerja PIHAK KEDUA setiap 3
                  (tiga) bulan sekali.
                </td>
              </tr>
              <tr>
                ...
                <td>
                  PIHAK PERTAMA dapat melakukan evaluasi secara mendadak apabila
      ...
      <div className="w-[8.5in] min-h-[11in] bg-white flex flex-col page">
        ...
        <div className="mx-[70pt] leading-tight flex-grow">
          ...
          <table className=" table-fixed">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Bilamana PIHAK KEDUA akan memperpanjang Perjanjian Kerja, maka
                  PIHAK KEDUA diwajibkan mengajukan permohonan perpanjangan
                  kepada PIHAK PERTAMA paling lambat 7 (tujuh) hari sebelum
                  Perjanjian Kerja ini berakhir dan dengan kesepakatan kedua
                  belah pihak dibuatkan perpanjangan Perjanjian Kerja.
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  kesepakatan antara PIHAK PERTAMA dan PIHAK KEDUA, maka
                  Perjanjian Kerja ini akan putus demi hukum pada tanggal yang
                  telah disepakati, sehingga kedua belah pihak berakhir dengan
                  sendirinya.
                </td>
              </tr>
            </tbody>
          ...
          <table className=" table-fixed">
            <tbody>
              <tr>
                ...
                <td>
                  Kegagalan salah satu pihak untuk melaksanakan perjanjian kerja
                  ini yang disebabkan oleh <i>force majure</i> tidak dianggap
                  sebagai pelanggaran terhadap perjanjian ini. FORCE MAJURE
                  adalah segala keadaan atau peristiwa yang terjadi di luar
                  batas kekuasaan KEDUA PIHAK, termasuk akan tetapi tidak
                  terbatas pada huru hara, epidemic, kebakaran, banjir gempa
                  bumi, pemogokan, perang, keputusan pemerintah yang menghalangi
                  KEDUA PIHAK secara langsung untuk melaksanakan
              ...
              <tr>
                ...
                <td>
                  ...
                  untuk memberitahukan secara tertulis kepada pihak lainnya saat
                  kejadian terjadi.
                </td>
              </tr>
              <tr>
          ...
          <p>
            ...
            perselisihan kepentingan dan perselisihan PHK yang berkaitan dengan
        ...
        <div className="mx-[70pt] leading-tight flex-grow">
          ...
          <div className="flex justify-around mt-[70pt]">
            <div className="text-center">
              <p className="pb-[60pt]">PIHAK PERTAMA</p>
              <p
              ...
              <span className="no-underline font-bold">
                {props.jabatan_pk_ptm}
              </span>
            </div>
            <div className="text-center">
              <p className="pb-[60pt]">PIHAK KEDUA</p>
              <p
                className="font-bold underline underline-offset-[2.7pt]"
                style={{ textDecorationThickness: "1pt" }}
              >
