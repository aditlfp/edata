  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(`api/${data.client_id}`).then((response) => {
        var _a2;
        if (((_a2 = response.data) == null ? void 0 : _a2.client_id) != null) {
              ...
              data.initials ? /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex gap-x-2", children: [
                  /* @__PURE__ */ jsx(
                    ...
                    {
                      type: "text",
                      className: "input input-sm input-bordered rounded-sm w-1/4",
                      disabled: true,
                      value: data.initials,
                      readOnly: true
                    }
                  ...
                  /* @__PURE__ */ jsx(
                    ...
                    {
                      type: "text",
                      className: "input input-sm input-bordered rounded-sm w-1/3",
                      value: data.numbers,
                  ...
                  /* @__PURE__ */ jsx(
                    ...
                    {
                      type: "month",
                      className: "input input-sm input-bordered rounded-sm w-1/2",
