...
function Modal({ props, children, modalTitle }) {
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 backdrop-blur-xl flex justify-center overflow-y-auto px-4 py-6 sm:px-0 items-center z-50 transform transition-all ease-linear .2s", children: /* @__PURE__ */ jsx(
    "div",
    {
